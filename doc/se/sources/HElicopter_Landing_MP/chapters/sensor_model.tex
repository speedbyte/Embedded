...
The sensors will be connected to a Raspberry Pi Board mounted on a Quadrocopter (HElikopter).
...
\begin{figure}[H]
	\centering
		\includegraphics{fig/ADS1115_example.png}%[width=1.0\textwidth]
	\label{fig:IMU_Gyro}
...
\begin{figure}[H]
	\centering
		\includegraphics{fig/IR_PololuCarrier}%[width=1.0\textwidth]
	\label{fig:IMU_Gyro}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.6\textwidth]{fig/Adafruit_GPSHAT}%
	\label{fig:GPSHAT}
...
\begin{figure}[H]
	\centering
		\includegraphics{fig/GPS_modul}%[width=1.0\textwidth]
	\label{fig:GPSModul}
	\caption{GPS modul}
\end{figure}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.6\textwidth]{fig/Pololu_AltIMU}
	\label{fig:IMU_Gyro}
...
\begin{figure}[H]
	\centering
		\includegraphics{fig/LIDAR_Laser}%[width=0.6\textwidth]
