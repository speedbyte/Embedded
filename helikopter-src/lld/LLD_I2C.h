 ...
 * -------------------------------------------------------------------- */
unsigned int g_lldI2c_Write_bool(unsigned char, const unsigned char*, unsigned int);
unsigned int g_lldI2c_Read_bool(unsigned char, const unsigned char*, unsigned int);
