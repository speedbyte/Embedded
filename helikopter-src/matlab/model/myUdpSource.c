...
#define MDL_START  /* Change to #undef to remove function */
  ...
  static void mdlStart(SimStruct *S)
  {
     ...
     m_simSocketNumber = g_halMatlab_initConnection_i32( remoteIpAddr, listenPort);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    myUdpSource_Outputs_wrapper(acc, gyro, mag, baro, temp, sampleTime, p_width0, m_simSocketNumber);
}
