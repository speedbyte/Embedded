...
int g_halBaro_initBaro_i32(void)
{
    ...
    if(g_lldI2c_Write_bool(M_I2C_SLAVE_ADDRESS_BARO_UI8, l_WriteBuffer_ui8, M_HAL_BARO_NR_OF_BYTES_TWO_UI8)!=0)
    {return -1;}
    ...
    if(g_lldI2c_Write_bool(M_I2C_SLAVE_ADDRESS_BARO_UI8, l_WriteBuffer_ui8, M_HAL_BARO_NR_OF_BYTES_THREE_UI8)!=0)
    {return -1;}
...
int g_halBaro_readPressureFromI2C_i32(void)
{
    ...
    if(g_lldI2c_Write_bool(M_I2C_SLAVE_ADDRESS_BARO_UI8, l_WriteBuffer_ui8, M_HAL_BARO_NR_OF_BYTES_ONE_UI8)!=0)
    {return -1;}


    //Read from PRESS_OUT_XL(0x28),PRESS_OUT_L(0x29),PRESS_OUT_H(0x2A)
    if(g_lldI2c_Read_bool(M_I2C_SLAVE_ADDRESS_BARO_UI8, l_ReadBuffer_ui8, M_HAL_BARO_NR_OF_BYTES_THREE_UI8)!=0)
    {return -1;}
    else
    {
...
int g_halBaro_readTemperatureFromI2C_i32(void)
{
    ...
    if(g_lldI2c_Read_bool(M_I2C_SLAVE_ADDRESS_BARO_UI8, l_ReadBuffer_ui8, M_HAL_BARO_NR_OF_BYTES_TWO_UI8)!=0)
    {return -1;}
    else
    {
        //move MSB to position 0
