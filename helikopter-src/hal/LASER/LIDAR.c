...
if(g_lldI2c_Write_bool(M_I2C_SLAVE_ADDRESS_LIDAR_UI8, l_WriteBuffer_ui8, 2)!=0)
{
return -1;
}
...
if(g_lldI2c_Write_bool(M_I2C_SLAVE_ADDRESS_LIDAR_UI8, l_WriteBuffer_ui8, 1)!=0)
{
return -1;
}

//Read 2-Byte Distance in cm from Register 0x8f
if(g_lldI2c_Read_bool(M_I2C_SLAVE_ADDRESS_LIDAR_UI8, (l_ReadBuffer_ui8), 2)!=0)
{
return -1;
}
